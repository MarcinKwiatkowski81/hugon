...
Hugon is a lightweight C++17 JSON library. It based on implementation by Bohdan R. Rau <ethanak[at]polip.com> in Python to parse huge JSON data that doesn't fit in memory. It consists of 3 parts:
