...
Hugon is a lightweight C++17 JSON library. It based on implementation by ethanak in Python to parse huge JSON data that doesn't fit into memory. It consists of 3 parts:
